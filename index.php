...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <title>Talkevo Global Learning and Development Center | talkevoglobal.com</title>
  ...
  <body>
    ...
    <main class="main" id="top">
      ...
      <section class="py-0">
        <div class="bg-holder bg-theme" >
        </div> 

        <div class="container position-relative ">
          <div class="row align-items-center py-6 py-md-10">
            <div class="col-md-7 order-md-1 text-center text-md-end">
                <img  class="img-fluidi" src="assets/img/hero-img.svg" width="700px" alt="" />
            </div>
            <div class="col-md-5 text-center text-md-start">
                <!-- <span class="badge bg-dark rounded-pill text-light align-items-center d-flex flex-row-reverse justify-content-end mx-auto mx-md-0 ps-0 w-75 w-sm-50 w-md-75 w-xl-50 mb-3"> Live Online Classes <img class="img-fluid float-start me-3" src="assets/img/illustrations/arrow-right.png" alt=""/></span> -->
                <h4 class="mb-4 display-3 fw-bold lh-1 text-light">
                  Unlock your Kid's Potentials<br class="d-block d-lg-none d-xl-block" /> 
                  Strive for Excellence!</h4>
                  <h1 class="mb-4 display-3 fw-bold lh-sm text-light">Think Global, <br class="d-block d-lg-none d-xl-block" />Speak Global! 
                </h1>
                <p class="mt-3 mb-4 fs-1 text-light">Discover fun, social, and safe learning experiences for kids.</p>
                <a class="btn btn-lg  bg-gold rounded-pill hover-top" href="#" role="button">INQUIRE NOW</a>
                <!-- <a class="btn btn-link ps-md-4 text-light" href="#" role="button"> Watch demo video</a> -->
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="py-5" id="howitworks">
        <div class="container-lg">
          <div class="row align-items-center">
            <div class="col-md-4 col-lg-6 order-md-0 text-center text-md-start"><img class="img-fluid" src="assets/img/illustrations/feature-bg.png" width="550" alt="" /></div>
            <div class="col-md-6 col-lg-6 px-sm-5 px-md-0">
              <h6 class="fw-bold fs-4 display-3 lh-sm">How it Works</h6>  
              
              <div class="row">
                <div class="d-flex justify-content-start my-2">
                  <div><img class="img-fluid" src="assets/img/illustrations/fast-performance.png" width="90" alt="" /></div>
                  <div class="px-4">
                    <h5 class="fw-bold text-danger">Personalized Materials</h5>
                    <p>Interactive and contextual activities blend with extended learning within their reach.</p>
                  </div>
                </div>
                ...
                <div class="d-flex justify-content-start my-2">
                  <div><img class="img-fluid" src="assets/img/illustrations/fast-performance.png" width="90" alt="" /></div>
                  <div class="px-4">
                    <h5 class="fw-bold text-primary">Improve Holistically</h5>
                    <p>We start simply and gradually make the program more complicated. At the same time we control the educational process and continuously revise and improve the learning material.</p>
                  </div>
                </div> 
                ...
                <div class="d-flex justify-content-start my-2">
                  <div><img class="img-fluid" src="assets/img/illustrations/fast-performance.png" width="90" alt="" /></div>
                  <div class="px-4">
                    <h5 class="fw-bold text-success">Immediate Grading</h5>
                    <p>Every teacher in our team is a certified ESL specialist with online teaching experience.</p>
                  </div>
                </div>
                ...
                <div class="d-flex justify-content-start my-2">
                  <div><img class="img-fluid" src="assets/img/illustrations/fast-performance.png" width="90" alt="" /></div>
                  <div class="px-4">
                    <h5 class="fw-bold text-info">Building New Comfort Zones</h5>
                    <p>Getting the kids to communicate confidently and equipping them with essential language skills.</p>
                  </div>
                </div>
                ...
                <div class="d-flex justify-content-start my-2">
                  <div><img class="img-fluid" src="assets/img/illustrations/fast-performance.png" width="90" alt="" /></div>
                  <div class="px-4">
                    <h5 class="fw-bold text-success">Global Interaction</h5>
                    <p>Chance of knowing each nation and participating in real world conversation thru global meetings.</p>
                  </div>
                </div>  
              </div>
        ...
        <div class="container">
          <div class="row align-items-center"> 
            <div class="col-md-6  offset-md-1 text-center text-md-start">
              <h6 class="fw-bold fs-4 display-3 lh-sm">Broaden your Child's Horizon</h6>
              <p class="my-4 pe-xl-5"> Grow your learner’s confidence in and out of the classroom with live video classes that meet in small groups.</p><a class="btn btn-lg btn-primary rounded-pill hover-top" href="#" role="button">Learn more</a>
            </div>
      ...
      <section class="py-6">
        ...
        <div class="container">
          <div class="container">
            <div class="row align-items-center">
              <div class="col-md-5 order-md-first text-center text-md-start"><img class="img-fluid mb-4" src="assets/img/illustrations/ultimate-feature.png" alt="" /></div>
              <div class="col-md-6 text-center text-md-start">
                <h6 class="fw-bold fs-4 display-3 lh-sm">Key Learnings</h6>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="mb-4">
                      ...
                      <h5 class="fw-bold text-undefined">Basics of English Grammar</h5>
                  ...
                  <div class="col-md-6">
                    <div class="mb-4">
                      ...
                      <h5 class="fw-bold text-undefined">Sentence Construction</h5>
                      <p class="mt-2 mb-0">Get your blood tests delivered at home collect a sample from the news your blood tests.</p>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="mb-4">
                      ...
                      <h5 class="fw-bold text-undefined">Comprehension</h5>
                      <p class="mt-2 mb-0">Get your blood tests delivered at home collect a sample from the news your blood tests.</p>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="mb-4">
                      ...
                      <h5 class="fw-bold text-undefined">Effective Communication</h5>
                      <p class="mt-2 mb-0">Get your blood tests delivered at home collect a sample from the news your blood tests.</p>
                    </div>
                  </div>
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6 col-xxl-5 text-center mb-3">
              <h6 class="fw-bold fs-4 display-3 lh-sm mb-3">Pricing</h6>
          ...
          <div class="row flex-center">
            ...
            <div class="col-lg-4">
              <div class="card shadow-lg mb-4 border-0">
                <div class="card-header border-bottom-0 pt-7 pb-5">
                  <div class="d-flex justify-content-center">
                    <h1 class="fw-bold">$59</h1><span class="d-flex align-items-center">/month</span>
                  </div>
                  <h5 class="fw-bold text-center">BEGINNER</h5><span class="text-700 text-center d-block">Lorem Ipsum</span>
                </div>
                <div class="card-body mx-auto">
                  <ul class="list-unstyled mb-4">
                    <li class="text-700 py-2 text-secondary">Lorem Ipsum</li>
                    <li class="text-700 py-2 text-secondary">Lorem Ipsum</li>
                    <li class="text-700 py-2 text-secondary">Lorem Ipsum</li>
                    <li class="text-700 py-2 text-secondary">Lorem Ipsum</li>
                    <li class="text-700 py-2 text-secondary">Lorem Ipsum</li> 
                  </ul><a class="btn btn-lg btn-primary rounded-pill mb-3" href="#">Inquire</a>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-4">
              <div class="card shadow-lg mb-4">
                <div class="card-header border-bottom-0 pt-7 pb-5">
                  ...
                  <h5 class="fw-bold text-center">PRO </h5><span class="text-700 text-center d-block">Lorem Ipsum</span>
                </div>
                <div class="card-body mx-auto">
                  <ul class="list-unstyled mb-4">
                    <li class="text-700 py-2 text-secondary">Lorem Ipsum</li>
                  ...
                  <div class="d-flex flex-column"> <a class="btn btn-lg btn-primary rounded-pill mb-3" href="#">Inquire</a></div>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-4">
              <div class="card shadow-lg mb-4 border-0">
                <div class="card-header border-bottom-0 pt-7 pb-5">
                  <div class="d-flex justify-content-center">
                    <h1 class="fw-bold">$199</h1><span class="d-flex align-items-center">/month</span>
                  </div>
                  <h5 class="fw-bold text-center">MASTER</h5><span class="text-700 text-center d-block">Lorem Ipsum</span>
                </div>
                <div class="card-body mx-auto">
                  <ul class="list-unstyled mb-4">
                    <li class="text-700 py-2 text-secondary">Lorem Ipsum</li>
        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-md-7 col-lg-5 text-center text-md-start">
              <h1 class="display-3 fw-bold lh-sm">Enroll Now!</h1>
          ...
          <div class="row flex-center">
            <div class="col-auto mb-5">
              <ul class="list-unstyled list-inline mb-0">
                <li class="list-inline-item me3 me-sm-4"><a class="text-primary text-decoration-none" href="#!">Home</a></li>
                <li class="list-inline-item me3 me-sm-4"><a class="text-primary text-decoration-none" href="#!">Key Features</a></li>
                <li class="list-inline-item me3 me-sm-4"><a class="text-primary text-decoration-none" href="#!">Pricing</a></li>
                <li class="list-inline-item me3 me-sm-4"><a class="text-primary text-decoration-none" href="#!">Testimonial</a></li>
                <li class="list-inline-item me3 me-sm-4"><a class="text-primary text-decoration-none" href="#!">FAQ</a></li>
              </ul>
            </div>
          </div>
          <div class="row flex-center">
